...
export default function FloatingActionBar({
  ...
  return (
    <TooltipProvider>
      <div className="absolute top-full right-0 z-10 flex items-center gap-0 overflow-hidden rounded shadow-md">
        {/* 添加一行 */}
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              size="sm"
              className="h-5 rounded-none border-r border-black/20 bg-teal-500 px-1 text-white hover:bg-teal-600"
              onClick={() => onAddRow(1)}
            >
          ...
          <TooltipTrigger asChild>
            ...
            >
              <span className="flex items-center justify-center gap-0.5">
                ...
                <svg className="h-3 w-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                  <path
                    fill="currentColor"
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              size="sm"
              className="h-5 rounded-none bg-red-500 px-1.5 text-white hover:bg-red-600"
              onClick={onDelete}
            >
              <svg className="h-3 w-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path
